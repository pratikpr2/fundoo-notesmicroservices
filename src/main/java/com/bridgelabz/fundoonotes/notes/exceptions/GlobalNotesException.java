...
public class GlobalNotesException {
	...
	public ResponseEntity<NoteResponseDto> handleMalformedLink(TokenParsingException exception){
		logger.error("Error Occured while TokenParsing: "+ exception.getMessage(),exception);
